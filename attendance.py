...
logo = Image.open("UI_Image/eco_logo.png")
logo = logo.resize((80, 47), Image.LANCZOS)
...
titl = tk.Label(
    window, text="ECOVISION", bg="black", fg="WHITE", font=("arial", 27),
)
